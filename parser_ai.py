...
3. Нельзя сокращать, изменять, перефразировать или придумывать новые названия категорий, каждое название категории должно быть строго таким же как в списке категорий.
