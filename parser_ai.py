...
🧭 Логика:
1. Определи, является ли строка товаром: в ней должна быть цена и название и в названии не должно быть рекламных слов вроде "Акция", "Гарантия", "Подписка" и т.п.
