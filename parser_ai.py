...
7. Если в сообщении встречаются строки, которые выглядят как заголовки подкатегорий (например: "Poco", "Redmi", "Xiaomi Pad", "Apple", "Samsung", "GoPro", "Iphone", "Ipad", "MacBook" и т.д.), 
   считай их подкатегориями. 
   Все товары, идущие после такой строки, принадлежат этой подкатегории — пока не встретится новый заголовок.

8. Перед сохранением подкатегории обязательно очисти её:
   - Удали все эмодзи, флаги (🇷🇺, 🇪🇺 и т.п.), скобки, ссылки и лишние символы.
   - Оставь только одно короткое чистое название (например: "Poco", "Redmi", "Xiaomi Pad", "GoPro", "Iphone", "Ipad", "MacBook").
   - Используй строчную форму, например: "poco", "redmi", "xiaomi pad".
