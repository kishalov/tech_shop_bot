...
2. Распознай тип (смартфон, ноутбук, игрушка, смарт-часы и т.д.) и выбери подходящую категорию из списка. Категория должна быть обязательно у каждого товара.
3. Не придумывай новые категории.
