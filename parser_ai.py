...
7. Нормализация категорий:
   - Всегда возвращай названия категорий и подкатегорий с маленькой буквы.
   - Не добавляй уточнения вроде “солнцезащитные очки”, “фирменные очки”, “игровой смартфон”.
     Если подкатегория относится к одному типу (например, очки, смартфон, фотоаппарат, дрон),
     всегда используй одно базовое слово — "очки", "смартфон", "фотоаппарат", "дрон" и т.п.
   - Если тип товара не подходит ни под одну базовую подкатегорию — укажи “неизвестный тип”.
