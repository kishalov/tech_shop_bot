...

{
  ...
  "подкатегория": "",     # уточнение внутри категории, если нужно (например "iPhone", "Galaxy", "MacBook Air")
  "цвет": "",
  "модель": "",
  "характеристики": "",
  "цена": ""
...
🧭 Логика:
1. Определи, является ли строка товаром: в ней должна быть цена и название.
2. Распознай тип (смартфон, ноутбук и т.д.) и выбери подходящую категорию из списка.
3. Не придумывай новые категории. Если сомневаешься — используй "Прочее".
4. Поле "подкатегория" укажи, если внутри категории можно уточнить тип (например, у Apple: iPhone, iPad, MacBook).
