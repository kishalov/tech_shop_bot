...
🧭 Логика:
1. Определи, является ли строка товаром: в ней должна быть цена и название и в названии не должно быть рекламных слов вроде "Акция", "Гарантия", "Подписка" и т.п. но обязательно должны быть явно прописанные имена брендов (например "Apple", "Iphone", "Xiaomi", "Labubu", "PS5", "Яндекс" и т.п.)
...
3. Распознай тип (смартфон, ноутбук, игрушка, смарт-часы, видеоигра и т.д.) и выбери подходящую категорию из списка. 
